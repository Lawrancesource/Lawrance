...
local t = json:decode(https.request('https://brok-aapi.ml/API/Hadi.php?id='..database:get(Server_Done.."UserSudo_Write").."&token="..database:get(Server_Done.."Token_Write")))
print("::Lawrance::")
local RunBot = io.open("Lawrance", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/Lawrance
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr Lawrance.lua
wget "https://raw.githubusercontent.com/Lawrancesource/Lawrance/master/Lawrance.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./Lawrance.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S Lawrance -X kill
screen -S Lawrance ./Lawrance
done
]])
RunTs:close()
end
